...
/**
* Implementation of the ground-motion model by Zhao et al. (2006) added by Carlo Cauzzi for SED-INETER Project;
* implementation based on the OpenQuake hazardlib (http://docs.openquake.org/oq-hazardlib/stable/_modules/openquake/hazardlib/gsim/zhao_2006.html#ZhaoEtAl2006Asc)
 */
...
public class ZEA06ASC implements AttenuationPGA, AttenuationPSA, AttenuationDRS {
    
	
	// Coefficients of the GMPE
	// period, a, b, c, d, e, FR, CH, C1, C2, C3, C4, sigma, QC, WC, tauC
    public static final double[][] Cofs = {
    		{0,1.101,-0.00564,0.0055,1.08,0.01412,0.251,0.293,1.111,1.344,1.355,1.42,0.604,0,0,0.303},
    		{0.05,1.076,-0.00671,0.0075,1.06,0.01463,0.251,0.939,1.684,1.793,1.747,1.814,0.64,0,0,0.326},
    		{0.1,1.118,-0.00787,0.009,1.083,0.01423,0.24,1.499,2.061,2.135,2.031,2.082,0.694,0,0,0.342},
    		{0.15,1.134,-0.00722,0.01,1.053,0.01509,0.251,1.462,1.916,2.168,2.052,2.113,0.702,0,0,0.331},
    		{0.2,1.147,-0.00659,0.012,1.014,0.01462,0.26,1.28,1.669,2.085,2.001,2.03,0.692,0,0,0.312},
    		{0.25,1.149,-0.0059,0.014,0.966,0.01459,0.269,1.121,1.468,1.942,1.941,1.937,0.682,0,0,0.298},
    		{0.3,1.163,-0.0052,0.015,0.934,0.01458,0.259,0.852,1.172,1.683,1.808,1.77,0.67,0,0,0.3},
    		{0.4,1.2,-0.00422,0.01,0.959,0.01257,0.248,0.365,0.655,1.127,1.482,1.397,0.659,0,0,0.346},
    		{0.5,1.25,-0.00338,0.006,1.008,0.01114,0.247,-0.207,0.071,0.515,0.934,0.955,0.653,-0.0126,0.0116,0.338},
    		{0.6,1.293,-0.00282,0.003,1.088,0.01019,0.233,-0.705,-0.429,-0.003,0.394,0.559,0.653,-0.0329,0.0202,0.349},
    		{0.7,1.336,-0.00258,0.0025,1.084,0.00979,0.22,-1.144,-0.866,-0.449,-0.111,0.188,0.652,-0.0501,0.0274,0.351},
    		{0.8,1.386,-0.00242,0.0022,1.088,0.00944,0.232,-1.609,-1.325,-0.928,-0.62,-0.246,0.647,-0.065,0.0336,0.356},
    		{0.9,1.433,-0.00232,0.002,1.109,0.00972,0.22,-2.023,-1.732,-1.349,-1.066,-0.643,0.653,-0.0781,0.0391,0.348},
    		{1,1.479,-0.0022,0.002,1.115,0.01005,0.211,-2.451,-2.152,-1.776,-1.523,-1.084,0.657,-0.0899,0.044,0.338},
    		{1.25,1.551,-0.00207,0.002,1.083,0.01003,0.251,-3.243,-2.923,-2.542,-2.327,-1.936,0.66,-0.1148,0.0545,0.313},
    		{1.5,1.621,-0.00224,0.002,1.091,0.00928,0.248,-3.888,-3.548,-3.169,-2.979,-2.661,0.664,-0.1351,0.063,0.306},
    		{2,1.694,-0.00201,0.0025,1.055,0.00833,0.263,-4.783,-4.41,-4.039,-3.871,-3.64,0.669,-0.1672,0.0764,0.283},
    		{2.5,1.748,-0.00187,0.0028,1.052,0.00776,0.262,-5.444,-5.049,-4.698,-4.496,-4.341,0.671,-0.1921,0.0869,0.287},
    		{3,1.759,-0.00147,0.0032,1.025,0.00644,0.307,-5.839,-5.431,-5.089,-4.893,-4.758,0.667,-0.2124,0.0954,0.278},
    		{4,1.826,-0.00195,0.004,1.044,0.0059,0.353,-6.598,-6.181,-5.882,-5.698,-5.588,0.647,-0.2445,0.1088,0.273},
    		{5,1.825,-0.00237,0.005,1.065,0.0051,0.248,-6.752,-6.347,-6.051,-5.873,-5.798,0.643,-0.2694,0.1193,0.275}
    };
    ...
    public Shaking getPGA(double magnitude, double sourceLat, double sourceLon,
        ...
        double logpgasite = P * (Mw - M) + Cofs[0][13] * pow((Mw - M),2) + Cofs[0][14] + Cofs[0][1] * Mw + Cofs[0][2] * Rrup - log(Rrup + Cofs[0][3] * exp(Cofs[0][4] * Mw)) + dterm + S;
    ...
    public Shaking getPSA(double magnitude, double sourceLat, double sourceLon,
        ...
        // PSA including site term
        double logpsasite = P * (Mw - M) + Cofs[cnt][13] * pow((Mw - M),2) + Cofs[cnt][14] + Cofs[cnt][1] * Mw + Cofs[cnt][2] * Rrup - log(Rrup + Cofs[cnt][3] * exp(Cofs[cnt][4] * Mw)) + dterm + S;
