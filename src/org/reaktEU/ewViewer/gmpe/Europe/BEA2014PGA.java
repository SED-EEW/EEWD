package org.reaktEU.ewViewer.gmpe.Europe;
...
public class BEA2014PGA implements AttenuationPGA {
...
/*
        ...
        if (Mw <= Mh) {
        	double FM = cofs[5][23] * ( Mw -Mh ) + cofs[6][23] * pow(( Mw - Mh ),2);
        } else {
        	double FM = cofs[7][23] * ( Mw -Mh );	
        }
